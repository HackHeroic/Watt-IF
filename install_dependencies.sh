...
conda install -n watt-if -c conda-forge pandas matplotlib seaborn missingno plotly -y

echo "Environment 'watt-if' created and packages installed successfully!"
